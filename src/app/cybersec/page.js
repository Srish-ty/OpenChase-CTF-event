...
export default function CyberSecRound() {
  ...
  useEffect(() => {
    ...
    async function fetchQuestion() {
      try {
        const response = await fetch(`/api/rounds?round=cybersec`);
  ...
  function generateOptions(correctAnswer) {
    const randomOptions = ["OptionI", "OptionII", "OptionIII"];
